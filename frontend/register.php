...
<head>
    ...
    <title>Register - AuthCRUD System</title>
    ...
    <style>
        * {
        ...
        .register-card .bi-person-plus-fill {
            color: #ffffff !important;
...
<body>
    ...
    <div class="register-card">
        <div class="text-center mb-4">
            ...
            <p class="mb-0" style="color: rgba(255,255,255,0.7); font-size: 14px;">Daftar akun baru untuk melanjutkan</p>
        </div>
        ...
        <div class="text-center mt-3">
            ...
            <a href="login.php" class="text-decoration-none fw-bold" style="color: #1b6ca8;">Login Sekarang</a>
        </div>
    </div>
