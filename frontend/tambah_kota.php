...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($httpCode == 200 || $httpCode == 201) {
        ...
        $error = "Gagal menambah data. Silakan coba lagi.";
    }
}
?>
...
<head>
    ...
    <title>Tambah Kota - AuthCRUD System</title>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_kota" class="form-control form-control-lg" placeholder="Masukkan nama kota" required>
                            </div>
                            <div class="mb-4">
                                <label class="form-label fw-semibold">
                                    <i class="bi bi-geo-alt me-2"></i>ID Propinsi
                                </label>
                                <input type="number" name="propinsi_id" class="form-control form-control-lg" placeholder="Masukkan ID propinsi" required>
                            </div>
